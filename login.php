...
if(mysqli_num_rows($result)>0){
        ...
        //header("Location:http://localhost/onlinevote/paritals/dashboard.php");
        header("Location: ../paritals/dashboard.php");
       echo '<script>
       alert("you are logging in");
        ...
        echo '<script>
         ...
         window.location="http://localhost/onlinevote/paritals/index.php";
        </script>';
        //echo "credentials  are mismatched.";
//header("Location: ../");
exit();
